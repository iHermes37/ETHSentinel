...
import (
	"fmt"
	Conn "github.com/Crypto-ChainSentinel/conn"
	"github.com/Crypto-ChainSentinel/lib/dex"
	"github.com/Crypto-ChainSentinel/models"
	"github.com/Crypto-ChainSentinel/modules/core/arbitrageur/mempool"
...
func (m *Monitor) GetPairReserves(
	d *models.DEXProtocol,
	pairAddr common.Address,
) (models.DexPairReserver, error) {

	// 初始化交易对实例
	pairContract, err := m.DexAapter.SelectDexPair(d, pairAddr)
	if err != nil {
		return models.DexPairReserver{}, err
	}
...
// 监控指定 DEX 新创建的交易对
func (m *Monitor) MonitoringNewPair(d *models.DEXProtocol) {
	// 选择工厂地址
...
// 处理新创建的代币池
func (m *Monitor) handleNewPairEvent(d *models.DEXProtocol, evt *uniswap_v2.Uniswapv2FactoryPairCreated) {
