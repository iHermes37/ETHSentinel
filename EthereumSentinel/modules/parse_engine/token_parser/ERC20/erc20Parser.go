...
import (
	erccommon "github.com/Crypto-ChainSentinel/modules/parse_engine/erc_parser/erccommon"
)
...
//func getERC20Meta(addr tools.Address, client *ethclient.Client) (string, int) {
...
//		token.To = tools.Address(params["_to"])
