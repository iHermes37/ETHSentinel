package parse_engine

import (
	"github.com/Crypto-ChainSentinel/modules/parse_engine/comm"
	dexparser "github.com/Crypto-ChainSentinel/modules/parse_engine/dex_parser"
)

func ParserEngine() *comm.ProtocolManager {
