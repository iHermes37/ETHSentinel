...
import (
	...
	abligens "github.com/Crypto-ChainSentinel/internal/lib/dex/uniswap_v2"
...
func ParseSwapEvent(log types.Log, metadata comm.EventMetadata) (comm.UnifiedEvent, error) {
