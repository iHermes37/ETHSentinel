...
func (r *WhaleRepository) QueryWhaleTrade(wq model.WhaleTradeParams, page int, pageSize int) ([]model.WhaleTradeResponse, error) {
	db := r.db.Model(&types.WhaleTransaction{})
...
// ==========================================================
func (r *WhaleRepository) FindAssetsByAddress(addr string) ([]*schemas.WhaleAssetsResponse, error) {
	var assets []*schemas.WhaleAssetsResponse
