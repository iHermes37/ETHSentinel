...
func (b *EventMetadata) BlockNumber() *big.Int { return b.BlockNumberVal }
func (b *EventMetadata) SetSwapData(data SwapData) {
	b.SwapDataVal = data
	b.SwapParsed = true
}
func (b *EventMetadata) SwapDataIsParsed() bool { return b.SwapParsed }
func (b *EventMetadata) OuterIndex() uint       { return b.OuterIndexVal }
func (b *EventMetadata) TransactionIndex() uint { return b.TransactionIndexVal }
