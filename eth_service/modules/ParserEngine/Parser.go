...
import (
	dexcommon "github.com/Crypto-ChainSentinel/modules/ParserEngine/DexParser/dexcommon"
...
func ParserEngine() *common.ProtocolManager {
	...
	registry.RegisterProtocol(dexcommon.NewUniswapV2Registrar())
	// registry.RegisterProtocol(sushiswap.NewSushiSwapRegistrar())
